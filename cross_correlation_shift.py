...
def cross_correlation_shift(Path, PathBis):
    ...
    #---------------------------------------------------------------------------------------------------------------------------------------------------------------
    #print("lets go to the dark side")
 ...
 #   print(f'changed offset (y, x): {shift}')
    plt.show()
  #  print("image", image)
    res = cc_image.real
    print('ok')
...
shift = (-22.4, 13.32)
offset_image =  "C:/Users/tprimet/Documents/REPRISE/MS/MS2_unziped/20220519_134340/imgChannel_8.tiff"
